...
<main>
  <div class="hero">
    <div><h1>CPA Token Usage</h1><div class="hint" id="pool-hero-hint">按账号聚合 CPA usage：Token 消耗、缓存率、请求健康、账号当前上报的动态额度窗口和最近异常。</div></div>
    <div class="controls">
  ...
  <div class="command-grid">
    <section class="section"><h2><span>运行总览</span><span class="mini">请求 / Token / 缓存 / 限流</span></h2><div class="section-body"><div class="cards">
      ...
      <div class="metric" id="m-quota-card" style="--accent:var(--cyan)"><div class="label">窗口 2 额度估算</div><div class="value" id="m-7d-remaining">-</div><div class="sub" id="m-7d-remaining-sub">按账号最近探测到的窗口 2 估算</div></div>
